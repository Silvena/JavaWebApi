...
public class ResponseHeaders extends BaseClass{
    ...
    public void contentTypeIsJson()throws  IOException{
        ...
        org.apache.http.entity.ContentType content =  org.apache.http.entity.ContentType.getOrDefault(response.getEntity());
    ...
    @Test
    public void eTagIsPresesnt() throws  IOException{
        HttpGet get = new HttpGet(BASE_ENDPOINT);
        response = client.execute(get);
